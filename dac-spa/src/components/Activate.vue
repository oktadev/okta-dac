    ...
    <v-card class="mx-auto my-6 pb-1" width="600">
        ...
        <v-form ref="form" v-model="valid" v-if="!invalidToken">
            ...
            <v-card class="ma-4">
                ...
                <v-row no-gutters>
                    <div
                        class="caption mx-4 blue-grey--text"
                    >Password requirements: at least 8 characters, a lowercase letter, an uppercase letter, a number and a symbol; no parts of your username.</div>
                </v-row>
                <v-row no-gutters>
                    <v-col>
                        <v-text-field
                ...
                <v-progress-linear v-if="saving" indeterminate height="2"></v-progress-linear>
                <v-card-actions>
                    <v-btn text :disabled="!valid" @click="create">Create My Account</v-btn>
                </v-card-actions>
            </v-card>
        </v-form>
    </v-card>
