...
class ServerlessPlugin {
  constructor(serverless, options) {
    ...
    this.hooks = {
      ...
      "emptyBucket:emptyBucket": this.emptyBucket.bind(this),
    };
  }
  ...
  emptyBucket() {
    ...
    const { sterr } = this.runAwsCommand(args);
    if (!sterr) {
      this.serverless.cli.log("Successfully emptied the S3 bucket");
    } else {
      throw new Error("Failed emptying the S3 bucket");
    }
  }
